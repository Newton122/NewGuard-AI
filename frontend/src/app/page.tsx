...
function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-purple-600/10 blur-3xl" style={{ animationDelay: '2s' }} />
    </div>
  )
}
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative flex h-12 w-12 items-center justify-center">
        ...
        <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 shadow-lg shadow-blue-500/30">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 relative">
      ...
      <div
        className="fixed pointer-events-none z-0 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/5 blur-3xl transition-all duration-1000 ease-out"
        style={{
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-slate-800/50 bg-slate-900/60 backdrop-blur-xl">
      ...
      <section className="relative z-10 border-b border-slate-800/50">
        <div className="mx-auto max-w-7xl px-6 py-20 text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-950/30 px-4 py-2 text-sm text-blue-300 backdrop-blur-sm">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <a
              href="#detector"
              className="group relative overflow-hidden rounded-lg bg-blue-600 px-8 py-3.5 font-semibold text-white transition hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/30"
            >
            ...
            <a
              href="#how-it-works"
              className="rounded-lg border border-slate-700 px-8 py-3.5 font-semibold text-slate-200 transition hover:border-slate-600 hover:bg-slate-800/50"
            >
              Learn More
            </a>
          </div>
      ...
      {/* Detector */}
      <section id="detector" className="relative z-10 border-b border-slate-800/50">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-8 lg:grid-cols-2">
            {/* Input Card */}
            <div className="group rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-xl transition hover:border-slate-700/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-700/50 bg-slate-950/50 px-4 py-3 text-slate-100 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={10}
                    className="w-full rounded-xl border border-slate-700/50 bg-slate-950/50 px-4 py-3 text-slate-100 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none"
                ...
                <button
                  ...
                  className="group relative w-full overflow-hidden rounded-xl bg-blue-600 px-6 py-4 font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                >
            ...
            <div className="rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-xl">
              ...
              {!result && !error && (
                <div className="flex h-80 items-center justify-center rounded-xl border border-dashed border-slate-700/50 bg-slate-950/30">
              ...
              {result && (
                <div className="space-y-6">
                  {/* Overall Verdict */}
                  <div className={`rounded-xl border-2 p-6 text-center transition-all ${getRiskColor(result.risk_level)}`}>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="rounded-xl border border-slate-700/50 bg-slate-950/30 p-4 text-center transition hover:border-blue-500/30">
                      ...
                      <div className="mt-2 h-1.5 rounded-full bg-slate-800">
                        <div className="h-1.5 rounded-full bg-blue-500 transition-all" style={{ width: `${result.bert_score * 100}%` }} />
                      </div>
                    </div>
                    <div className="rounded-xl border border-slate-700/50 bg-slate-950/30 p-4 text-center transition hover:border-emerald-500/30">
                      ...
                      <div className="mt-2 h-1.5 rounded-full bg-slate-800">
                        <div className="h-1.5 rounded-full bg-emerald-500 transition-all" style={{ width: `${result.source_score * 100}%` }} />
                      </div>
                    </div>
                    <div className="rounded-xl border border-slate-700/50 bg-slate-950/30 p-4 text-center transition hover:border-purple-500/30">
                      ...
                      <div className="mt-2 h-1.5 rounded-full bg-slate-800">
                        <div className="h-1.5 rounded-full bg-purple-500 transition-all" style={{ width: `${result.heuristic_score * 100}%` }} />
                      </div>
                    </div>
                  </div>
      ...
      {/* Recent History */}
      <section id="history" className="relative z-10 border-b border-slate-800/50 bg-slate-900/20">
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          {history.length === 0 ? (
            <div className="rounded-xl border border-dashed border-slate-700/50 bg-slate-950/20 p-12 text-center">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative z-10 border-b border-slate-800/50 bg-slate-900/20">
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              <div
                key={idx}
                className="group relative overflow-hidden rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 transition hover:border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/10"
              >
                <div className="absolute top-0 right-0 text-8xl font-bold text-slate-800/20 group-hover:text-blue-500/10 transition">
                  {item.step}
                </div>
      ...
      {/* Under the Hood */}
      <section id="models" className="relative z-10 border-b border-slate-800/50">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mb-16 text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 transition hover:border-blue-500/30">
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-blue-600/10 text-blue-400">
            ...
            <div className="rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 transition hover:border-emerald-500/30">
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-emerald-600/10 text-emerald-400">
                <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            <div className="rounded-2xl border border-slate-800/50 bg-slate-900/40 p-8 transition hover:border-purple-500/30">
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-purple-600/10 text-purple-400">
                <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
